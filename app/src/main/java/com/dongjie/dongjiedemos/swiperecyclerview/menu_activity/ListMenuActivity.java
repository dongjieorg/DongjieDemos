...
public class ListMenuActivity extends BaseActivity {
    ...
    private SwipeMenuCreator swipeMenuCreator = new SwipeMenuCreator() {
        ...
        public void onCreateMenu(SwipeMenu swipeLeftMenu, SwipeMenu swipeRightMenu, int position) {
            ...
            {
                SwipeMenuItem addItem = new SwipeMenuItem(ListMenuActivity.this).setBackground(R.drawable.selector_green)
                    .setImage(R.mipmap.ic_action_add)
                    .setWidth(width)
                    .setHeight(height);
                swipeLeftMenu.addMenuItem(addItem); // 添加菜单到左侧。

                SwipeMenuItem closeItem = new SwipeMenuItem(ListMenuActivity.this).setBackground(R.drawable.selector_red)
            ...
            {
                SwipeMenuItem deleteItem = new SwipeMenuItem(ListMenuActivity.this).setBackground(R.drawable.selector_red)
    ...
    private OnItemMenuClickListener mMenuItemClickListener = new OnItemMenuClickListener() {
        ...
        public void onItemClick(SwipeMenuBridge menuBridge, int position) {
            ...
            if (direction == SwipeRecyclerView.RIGHT_DIRECTION) {
                Toast.makeText(ListMenuActivity.this, "list第" + position + "; 右侧菜单第" + menuPosition, Toast.LENGTH_SHORT).show();
            } else if (direction == SwipeRecyclerView.LEFT_DIRECTION) {
                Toast.makeText(ListMenuActivity.this, "list第" + position + "; 左侧菜单第" + menuPosition, Toast.LENGTH_SHORT).show();
            }
        }
    };
