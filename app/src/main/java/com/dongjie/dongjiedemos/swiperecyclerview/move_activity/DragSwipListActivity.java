 ...
 */
public class DragSwipListActivity extends BaseActivity {
        ...
        mRecyclerView.setOnItemMoveListener(new OnItemMoveListener() {
            ...
            public void onItemDismiss(RecyclerView.ViewHolder srcHolder) {
                ...
                if (mRecyclerView.getHeaderCount() > 0 && adapterPosition == 0) { // HeaderView。
                    ...
                    Toast.makeText(DragSwipListActivity.this, "HeaderView被删除。", Toast.LENGTH_SHORT).show();
                } else { // 普通Item。
            ...
            if (actionState == OnItemStateChangedListener.ACTION_STATE_DRAG) {
               LogUtils.showLog("状态：拖拽");
                ...
                viewHolder.itemView.setBackgroundColor(
                        ContextCompat.getColor(DragSwipListActivity.this, R.color.white_pressed));
                ...
                ViewCompat.setBackground(viewHolder.itemView,
                        ContextCompat.getDrawable(DragSwipListActivity.this, R.drawable.select_white));
            }
        }
    };
    ...
    private SwipeMenuCreator swipeMenuCreator = new SwipeMenuCreator() {
        ...
        public void onCreateMenu(SwipeMenu swipeLeftMenu, SwipeMenu swipeRightMenu, int position) {
            ...
            {
                SwipeMenuItem addItem = new SwipeMenuItem(DragSwipListActivity.this).setBackground(R.drawable.selector_green)
                    .setImage(R.mipmap.ic_action_add)
                    .setWidth(width)
                    .setHeight(height);
                swipeLeftMenu.addMenuItem(addItem); // 添加菜单到左侧。

                SwipeMenuItem closeItem = new SwipeMenuItem(DragSwipListActivity.this).setBackground(R.drawable.selector_red)
            ...
            {
                SwipeMenuItem deleteItem = new SwipeMenuItem(DragSwipListActivity.this).setBackground(R.drawable.selector_red)
    ...
    private OnItemMenuClickListener mMenuItemClickListener = new OnItemMenuClickListener() {
        ...
        public void onItemClick(SwipeMenuBridge menuBridge, int position) {
            ...
            if (direction == SwipeRecyclerView.RIGHT_DIRECTION) {
                Toast.makeText(DragSwipListActivity.this, "list第" + position + "; 右侧菜单第" + menuPosition, Toast.LENGTH_SHORT).show();
            } else if (direction == SwipeRecyclerView.LEFT_DIRECTION) {
                Toast.makeText(DragSwipListActivity.this, "list第" + position + "; 左侧菜单第" + menuPosition, Toast.LENGTH_SHORT).show();
            }
        }
    };
}