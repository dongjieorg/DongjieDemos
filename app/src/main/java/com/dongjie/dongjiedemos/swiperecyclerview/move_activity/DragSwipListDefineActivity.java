 ...
 * 拖拽支持自定义
 */
public class DragSwipListDefineActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.setOnItemMoveListener(new OnItemMoveListener() {
            ...
            public void onItemDismiss(RecyclerView.ViewHolder srcHolder) {
                ...
                Toast.makeText(DragSwipListDefineActivity.this, "现在的第" + position + "条被删除。", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private SwipeMenuCreator swipeMenuCreator = new SwipeMenuCreator() {
        ...
        public void onCreateMenu(SwipeMenu swipeLeftMenu, SwipeMenu swipeRightMenu, int position) {
            ...
            {
                SwipeMenuItem addItem = new SwipeMenuItem(DragSwipListDefineActivity.this).setBackground(R.drawable.selector_green)
                    .setImage(R.mipmap.ic_action_add)
                    .setWidth(width)
                    .setHeight(height);
                swipeLeftMenu.addMenuItem(addItem); // 添加菜单到左侧。

                SwipeMenuItem closeItem = new SwipeMenuItem(DragSwipListDefineActivity.this).setBackground(R.drawable.selector_red)
            ...
            {
                SwipeMenuItem deleteItem = new SwipeMenuItem(DragSwipListDefineActivity.this).setBackground(R.drawable.selector_red)
    ...
    private OnItemMenuClickListener mMenuItemClickListener = new OnItemMenuClickListener() {
        ...
        public void onItemClick(SwipeMenuBridge menuBridge, int position) {
            ...
            if (direction == SwipeRecyclerView.RIGHT_DIRECTION) {
                Toast.makeText(DragSwipListDefineActivity.this, "list第" + position + "; 右侧菜单第" + menuPosition, Toast.LENGTH_SHORT).show();
            } else if (direction == SwipeRecyclerView.LEFT_DIRECTION) {
                Toast.makeText(DragSwipListDefineActivity.this, "list第" + position + "; 左侧菜单第" + menuPosition, Toast.LENGTH_SHORT).show();
            }
        }
    };
}