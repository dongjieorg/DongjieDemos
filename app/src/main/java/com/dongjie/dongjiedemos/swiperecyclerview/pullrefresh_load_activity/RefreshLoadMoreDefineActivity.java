...
public class RefreshLoadMoreDefineActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_refresh_load_more_define);
    ...
    private OnItemClickListener mItemClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(View itemView, int position) {
            Toast.makeText(RefreshLoadMoreDefineActivity.this, "第" + position + "个", Toast.LENGTH_SHORT).show();
        }
    };
