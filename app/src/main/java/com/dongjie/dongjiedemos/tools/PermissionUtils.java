...
public class PermissionUtils {
    ...
    public static void permissionDialog(final Activity host, List<String> perms, @Nullable final AlertDialog.OnClickListener listener){
        ...
        for(String perm : perms){
            perNames.append(host.getString(permissionMap.get(perm)) + ",");
        }
     ...
     */
    static Map<String,Integer > permissionMap= new HashMap<>();
    static{
        permissionMap.put("android.permission.READ_CALENDAR", R.string.permission_readcalendar_txt);
        permissionMap.put("android.permission.WRITE_CALENDAR",R.string.permission_write_calendar_txt);

        permissionMap.put("android.permission.CAMERA",R.string.permission_camera_txt);

        permissionMap.put("android.permission.READ_CONTACTS",R.string.permission_readcontacts_txt);
        permissionMap.put("android.permission.WRITE_CONTACTS",R.string.permission_writecontacts_txt);
        permissionMap.put("android.permission.GET_ACCOUNTS",R.string.permission_getaccounts_txt);

        permissionMap.put("android.permission.ACCESS_FINE_LOCATION",R.string.permission_fine_location_txt);
        permissionMap.put("android.permission.ACCESS_COARSE_LOCATION",R.string.permission_coarse_location_txt);

        permissionMap.put("android.permission.RECORD_AUDIO",R.string.permission_recordaudio_txt);

        permissionMap.put("android.permission.READ_PHONE_STATE",R.string.permission_readphone_state_txt);
        permissionMap.put("android.permission.CALL_PHONE",R.string.permission_callphone_txt);
        permissionMap.put("android.permission.READ_CALL_LOG",R.string.permission_calllog_txt);
        permissionMap.put("android.permission.WRITE_CALL_LOG",R.string.permission_write_call_log_txt);
        permissionMap.put("android.permission.USE_SIP",R.string.permission_use_sip_txt);
        permissionMap.put("android.permission.PROCESS_OUTGOING_CALLS",R.string.permission_process_calls_txt);

        permissionMap.put("android.permission.BODY_SENSORS",R.string.permission_body_sensors_txt);

        permissionMap.put("android.permission.SEND_SMS",R.string.permission_sendsms_txt);
        permissionMap.put("android.permission.RECEIVE_SMS",R.string.permission_receive_sms_txt);
        permissionMap.put("android.permission.READ_SMS",R.string.permission_read_sms_txt);
        permissionMap.put("android.permission.RECEIVE_WAP_PUSH",R.string.permission_receive_wap_push_txt);
        permissionMap.put("android.permission.RECEIVE_MMS",R.string.permission_receive_mms_txt);

        permissionMap.put("android.permission.READ_EXTERNAL_STORAGE",R.string.permission_read_storage_txt);
        permissionMap.put("android.permission.WRITE_EXTERNAL_STORAGE",R.string.permission_write_storage_txt);
    }
